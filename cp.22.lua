...
--[[
    ═══════════════════════════════════════════════════════════════
    DEVELOPER NOTES - READ CAREFULLY
    ═══════════════════════════════════════════════════════════════
    
    CONFIGURATION CHECKLIST:
    
    ✅ 1. DATABASE CONFIGURATION
       Location: Line 30-37 (CONFIG.DATABASE)
       Current: https://raw.githubusercontent.com/lilyml2222-source/L/main/wl.json
       Format: {"Username1": "key1", "Username2": "key2"}
       Note: Script automatically bypasses cache for real-time updates
    
    ✅ 2. MAP SCRIPT LINKS
       Location: Line 58-141 (MAP_DATABASE)
       Action: Replace ALL "LINK_SCRIPT_XXXXX" with your raw GitHub URLs
       Example: 
       ["Mount Aetheria"] = {
           url = "https://raw.githubusercontent.com/USER/REPO/main/aetheria.lua",
           description = "Advanced mountain climbing experience",
           difficulty = "Easy",
           icon = "🏔️"
       }
    ...
    ✅ 3. DISCORD LINK
       Location: Line 52 (CONFIG.INFO.DISCORD)
       Current: "https://discord.gg/your-premium-server"
       Action: Replace with your actual Discord invite link
    
    ✅ 4. ADMIN LIST
       Location: Line 68-72 (CONFIG.ADMIN_LIST)
       Current: {123456789, 987654321}
       Action: Add UserIDs of admins you want to auto-kick
       Note: Get UserID from profile URL or API
    
    ═══════════════════════════════════════════════════════════════
    PREMIUM FEATURES INCLUDED:
    ═══════════════════════════════════════════════════════════════
    
    ✓ Advanced Key System with retry logic
    ✓ Real-time database sync (no cache)
    ✓ Professional UI with 7 tabs
    ✓ Smart error handling everywhere
    ✓ Performance optimizer (3 levels)
    ✓ Anti-AFK system
    ✓ Admin detection & auto-kick
    ✓ Memory management
    ✓ Custom animations
    ✓ Server hop & rejoin
    ✓ Full bright & noclip
    ✓ Infinite jump
    ✓ Speed & jump power sliders
    ...
    Q: Player gets kicked "Access Denied"
    A: Make sure username is in wl.json file
    
    Q: Maps not loading
    A: Check if raw GitHub links are correct and accessible
    
    Q: Script not updating from GitHub
    A: Clear Roblox cache or wait 1-2 minutes
    
    Q: Performance issues
    A: Use Ultra FPS boost mode in Performance tab
    
    Q: Animations not working
    A: Make sure animation IDs are correct and public
    
    ═══════════════════════════════════════════════════════════════
    CREDITS:
    ═══════════════════════════════════════════════════════════════
    
    • Rayfield Library: sirius.menu
    • Script Developer: Expert Roblox Luau Developer
    • Framework: Custom Premium Framework
